...
import { DiceRoller as DiceRollerUtil, SpecialDieFace } from '@/utils/diceRoller';

const SpecialDieIcon: React.FC<{ face: SpecialDieFace }> = ({ face }) => {
  const getBackgroundColor = () => {
    switch (face) {
      case 'barbarian': return 'bg-red-500';
      case 'merchant': return 'bg-yellow-500';
      case 'politics': return 'bg-green-500';
  ...
  return (
    <div className={`w-16 h-16 ${getBackgroundColor()} rounded-lg flex items-center justify-center`}>
        ...
        <div className="mt-4 text-center">
          <div className="flex justify-center space-x-4 mb-2">
            ...
            {currentRoll.specialDie && (
              <SpecialDieIcon face={currentRoll.specialDie} />
            )}
          </div>
